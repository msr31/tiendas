<template>
  <v-app>
    <dialogo-permiso-denegado
      @cerrar="dialogos.permisoDenegado = false"
      :mostrar="dialogos.permisoDenegado"
      :permiso="permisoDenegado"
    ></dialogo-permiso-denegado>

    <v-snackbar :timeout="5000" :top="true" v-model="snackbars.errorDeServidor">
      Error de servidor: {{ errorDeServidor }}
      <v-btn flat color="pink" @click.native="snackbars.errorDeServidor = false"
        >OK</v-btn
      >
    </v-snackbar>
    <v-snackbar
      :timeout="10000"
      :top="true"
      v-model="snackbars.permisoDenegado"
    >
      Permiso denegado: {{ permisoDenegado }}
      <br />
      <v-btn flat color="pink" @click.native="snackbars.permisoDenegado = false"
        >OK</v-btn
      >
    </v-snackbar>
    <v-navigation-drawer
...
export default {
  ...
  data() {
    return {
      ...
      right: true,
      rightDrawer: false,
      tituloGrande: "Sistema de Gestion Rapimall",
    };
  },
  name: "App",
};
