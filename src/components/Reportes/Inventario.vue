    ...
    <v-layout row wrap>
      <v-flex xs12 sm6 md3>
        <v-card height="100%" color="blue lighten-2" dark>
          <v-card-title class="sin-padding-inferior">
            <h1 class="headline">{{reporte.CantidadProductos}}
            </h1>
          </v-card-title>
          <v-card-text class="sin-padding-superior">
            <p class="subheading" title="Cantidad de productos distintos que hay en el inventario">Productos en
              inventario</p>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12 sm6 md3>
        <v-card height="100%" color="indigo lighten-2" dark>
          <v-card-title class="sin-padding-inferior">
            <h1 class="headline">{{reporte.PrecioVenta | currency}}
            </h1>
          </v-card-title>
          <v-card-text class="sin-padding-superior">
            <p class="subheading" title="Sumatoria del precio de venta multiplicado por la existencia de cada producto">
              Precio del inventario</p>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12 sm6 md3>
      ...
      <v-flex xs12 sm6 md3>
        <v-card height="100%" color="green darken-1" dark>
          <v-card-title class="sin-padding-inferior">
            <h1 class="headline">{{reporte.PrecioVenta - reporte.PrecioCompra | currency}}
            </h1>
          </v-card-title>
          <v-card-text class="sin-padding-superior">
            <p class="subheading" title="Precio del inventario - Costo del inventario">Utilidad total</p>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            <seleccionador-fechas @cambio="consultarProductosMasVendidos"></seleccionador-fechas>
            <productos-mas-vendidos :productos="productosMasVendidos"></productos-mas-vendidos>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            <seleccionador-fechas @cambio="consultarProductosMenosVendidos"></seleccionador-fechas>
            <productos-menos-vendidos :productos="productosMenosVendidos"></productos-menos-vendidos>
          </v-card-text>
        </v-card>
      </v-flex>
    </v-layout>
