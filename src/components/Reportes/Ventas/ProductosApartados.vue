<template>
  <v-container>
    <dialogo-cambiar-producto @cerrar="dialogos.buscarProductoParaIntercambiar = false"
                              @producto-cambiado="onProductoCambiado"
                              :producto="productoParaIntercambiar"
                              :idApartado="idApartadoParaCambiar"
                              :mostrar="dialogos.buscarProductoParaIntercambiar"></dialogo-cambiar-producto>
    <v-dialog v-model="mostrar && !dialogos.buscarProductoParaIntercambiar">
      <v-card>
        ...
        <v-card-text>
          <v-data-table :headers="encabezadosProductos" :items="apartado.productos" hide-actions item-key="Numero">
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="justify-center layout px-0">
                  <v-btn title="Cambiar producto" icon class="mx-0"
