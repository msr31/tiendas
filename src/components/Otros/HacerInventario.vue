  ...
  <v-layout row wrap>
    ...
    <v-layout row wrap v-show="productosParaVerificar.length > 0">
      ...
      <v-flex xs12 v-show="log.length > 0">
        ...
        <v-card v-show="mostrarLog" style="max-height: 200px; overflow-y: scroll;">
          <v-card-text>
            <ul class="lista-log">
      ...
      <v-flex xs12>
        ...
        >
          <template slot="items" slot-scope="props">
            ...
            <td><strong>{{ props.item.Encontrados}}</strong></td>
            <td><strong>{{ props.item.Existencia - props.item.Encontrados}}</strong></td>
          </template>
        </v-data-table>
      </v-flex>
    </v-layout>
