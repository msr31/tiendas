<template>
  <v-layout>
    ...
    <v-tooltip top open-delay="0">
      <v-btn @click="dialogos.nuevo = true" fixed dark fab bottom fill-height slot="activator" right color="pink">
        <v-icon>add</v-icon>
      </v-btn>
      <span>Registrar cliente</span>
    </v-tooltip>
    <v-snackbar :timeout="2000" :bottom="true" v-model="snackbars.clienteGuardado">
      Cliente guardado correctamente
      <v-btn flat color="pink" @click.native="snackbars.clienteGuardado = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :bottom="true" v-model="snackbars.clienteEditado">
      Cambios guardados
      <v-btn flat color="pink" @click.native="snackbars.clienteEditado = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :bottom="true" v-model="snackbars.clienteEliminado">
      Cliente eliminado
      <v-btn flat color="pink" @click.native="snackbars.clienteEliminado = false">OK</v-btn>
    </v-snackbar>
  </v-layout>
</template>
<script>
