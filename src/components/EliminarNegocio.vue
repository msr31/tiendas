<template>
  <v-layout row wrap>
    <v-flex xs12>
      ...
      <p>Un último paso: confirma que realmente deseas eliminar tu cuenta (<strong>esta acción no se puede
        deshacer</strong>)
      </p>
      <v-btn :disabled="deshabilitarBoton" :loading="cargando" @click="confirmarEliminacion()" large color="error">
        Eliminar mi cuenta
      </v-btn>
