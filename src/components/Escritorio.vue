    ...
    <v-layout row wrap>
      <v-flex xs12 sm6 md3>
        <v-card color="blue lighten-2" dark>
          <v-card-title>
            <h1 class="headline">{{reporteCaja.VentasContado | currency}}
              <v-icon color="blue lighten-5" class="icono-tarjeta">attach_money</v-icon>
            </h1>
          </v-card-title>
          <v-card-text>
      ...
      <v-flex xs12 sm6 md3>
        <v-card color="indigo lighten-2" dark>
          <v-card-title>
            <h1 class="headline">{{reporteCaja.Anticipos + reporteCaja.Abonos | currency}}
              <v-icon color="indigo lighten-5" class="icono-tarjeta">credit_card</v-icon>
            </h1>
          </v-card-title>
          <v-card-text>
      ...
      <v-flex xs12 sm6 md3>
        <v-card color="amber lighten-1" dark>
          <v-card-title>
            <h1 class="headline">{{reporteCaja.Ingresos | currency}}
              <v-icon color="amber lighten-5" class="icono-tarjeta">trending_up</v-icon>
            </h1>
          </v-card-title>
          <v-card-text>
      ...
      <v-flex xs12 sm6 md3>
        <v-card color="red darken-1" dark>
          <v-card-title>
            <h1 class="headline">{{reporteCaja.Egresos | currency}}
              <v-icon color="red lighten-5" class="icono-tarjeta">trending_down</v-icon>
            </h1>
          </v-card-title>
          <v-card-text>
      ...
      <v-flex xs12 sm12 md6>
        <v-card>
          <v-card-text>
            <ventas-mes ref="graficaVentasMes" style="max-height:400px;"></ventas-mes>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12 sm12 md6>
        <v-card>
          <v-card-text>
            <ventas-anio ref="graficaVentasAnio" style="max-height:400px;"></ventas-anio>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12 sm4>
