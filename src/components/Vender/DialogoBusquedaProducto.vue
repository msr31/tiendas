<template>
  <v-dialog v-model="mostrar" persistent max-width="700">
    <v-card>
      ...
      <v-card-text>
        <autocompletado-productos @producto-seleccionado="productoSeleccionado"></autocompletado-productos>
      </v-card-text>
      <v-card-actions>
        <v-spacer></v-spacer>
...
<script>
  import AutocompletadoProductos from './AutocompletadoProductos';
