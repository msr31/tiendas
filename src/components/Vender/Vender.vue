  ...
  <v-layout>
    <v-flex xs12>
      <dialogo-busqueda-producto
        ...
        :mostrar="dialogos.buscar"></dialogo-busqueda-producto>
      ...
      <formulario-nuevo-cliente
        @cerrar-dialogo="dialogos.nuevoCliente = false" @cliente-guardado="onClienteGuardado"
        :mostrar="dialogos.nuevoCliente"></formulario-nuevo-cliente>
      <speed-dial
    ...
    <v-snackbar :timeout="5000" :top="true" :right="true" v-model="snackbars.ventaCorrecta">
      Venta realizada correctamente
      <v-btn flat color="pink" @click.native="snackbars.ventaCorrecta = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="5000" :top="true" :right="true" v-model="snackbars.apartadoCorrecto">
      Apartado realizado correctamente
      <v-btn flat color="pink" @click.native="snackbars.apartadoCorrecto = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.productoNoExistente">
      El producto no existe
      <v-btn flat color="pink" @click.native="snackbars.productoNoExistente = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.pagoCliente">
      El pago del cliente debe ser mayor o igual que el total
      <v-btn flat color="pink" @click.native="snackbars.pagoCliente = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.seleccionarCliente">
      Elige un cliente para continuar
      <v-btn flat color="pink" @click.native="snackbars.seleccionarCliente = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.seleccionarFecha">
      Elige la fecha en la que el apartado vence
      <v-btn flat color="pink" @click.native="snackbars.seleccionarFecha = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.agregarProductos">
      Para vender necesitas agregar productos
      <v-btn flat color="pink" @click.native="snackbars.agregarProductos = false">OK</v-btn>
    </v-snackbar>
    <v-snackbar :timeout="2000" :top="true" :right="true" v-model="snackbars.pagoExcedido">
      El anticipo debe ser menor al pago total
      <v-btn flat color="pink" @click.native="snackbars.pagoExcedido = false">OK</v-btn>
    </v-snackbar>
  </v-layout>
</template>
