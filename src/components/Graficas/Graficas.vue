      ...
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            ...
            <ventas-anio v-show="aniosSeleccionados.length > 0" ref="graficaVentasAnio"></ventas-anio>
            <v-alert v-show="aniosSeleccionados.length <= 0" value="true" type="info">
      ...
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            ...
            <ventas-mes ref="graficaVentasMes" v-show="mesSeleccionadoParaGraficaPorMes.mes !== undefined"></ventas-mes>
          </v-card-text>
        </v-card>
      </v-flex>
      <v-flex xs12>
      ...
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            ...
            <productos-nunca-vendidos :productos="productosNuncaVendidos"></productos-nunca-vendidos>
          </v-card-text>
        </v-card>
      </v-flex>
    </v-layout>
