...
type Cliente struct {
	Numero                                                                                                           int
	Nombre, NumeroTelefono, Cedula, Fechanac, Correoelec, Residencia, LugarTrab, Vendedor, Referencia, Observaciones string
}
